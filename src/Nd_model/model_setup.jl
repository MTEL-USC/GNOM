...
@initial_value @units @flattenable @limits @description struct Params{Tp} <: AbstractParameters{Tp}
    α_a::Tp            |  1.0   | NoUnits      | false |  (0,20)  | "Curvature of Nd release enhancement parabola"
    α_c::Tp            | -10.0  | per10000     | false | (-20,0)  | "Center of Nd release enhancement parabola"
    α_GRL::Tp          |  2.0   | NoUnits      | false |   (0,∞)  | "Geenland Nd release enhancement"
    σ_ε::Tp            |  0.5   | per10000     | false |   (0,5)  | "Per-pixel variance (std) of εNd"
    c_river::Tp        | 100.0  | pM           | false |   (0,∞)  | "River effective [Nd]"
    c_gw::Tp           | 100.0  | pM           | false |   (0,∞)  | "Surface groundwater effective [Nd]"
    σ_hydro::Tp        |  1e-10 | Mmol/yr      | false |   (0,∞)  | "Hydrothermal source magnitude"
    ε_hydro::Tp        |  10.0  | per10000     | false | (-10,15) | "Hydrothermal source εNd"
    ϕ_0::Tp            |  20.0  | pmol/cm^2/yr | false |   (0,∞)  | "Sedimentary flux at surface"
    ϕ_∞::Tp            |  10.0  | pmol/cm^2/yr | false |   (0,∞)  | "Sedimentary flux at infinite depth"
    z_0::Tp            | 200.0  | m            | false |   (0,∞)  | "Sedimentary flux depth attenuation"
    ε_EAsia_dust::Tp   |  -8.0  | per10000     | false | (-12,-2) | "EAsia dust εNd"
    ε_NEAf_dust::Tp    | -12.0  | per10000     | false | (-15,-9) | "NEAf dust εNd"
    ε_NWAf_dust::Tp    | -12.0  | per10000     | false | (-15,-9) | "NWAf dust εNd"
    ε_NAm_dust::Tp     |  -8.0  | per10000     | false | (-12,-4) | "NAm dust εNd"
    ε_SAf_dust::Tp     | -10.0  | per10000     | false | (-25,-6) | "SAf dust εNd"
    ε_SAm_dust::Tp     |  -3.0  | per10000     | false | ( -7, 0) | "SAm dust εNd"
    ε_MECA_dust::Tp    |  -2.0  | per10000     | false | ( -5, 3) | "MECA dust εNd"
    ε_Aus_dust::Tp     |  -4.0  | per10000     | false | ( -7,-1) | "Aus dust εNd"
    ε_Sahel_dust::Tp   | -12.0  | per10000     | false | (-15,-9) | "Sahel dust εNd"
    ...
    ε_volc::Tp         |    5.4 | per10000     | false |(2.7,8.0) | "Volcanic ash εNd"
    β_volc::Tp         |    2.0 | per100       | false |  (0,5)   | "Volcanic ash Nd solubility"
