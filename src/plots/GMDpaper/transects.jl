...
#save(joinpath(output_path, "Nd_transects.png"), s)
#save(joinpath(archive_path, "Nd_transects_$(lastcommit)_run$(run_num).png"), s)
use_GLMakie || save(joinpath(archive_path, "Nd_transects_$(lastcommit)_run$(run_num).pdf"), fig)
#use_GLMakie || save(joinpath(archive_path, "Nd_transects_$(lastcommit)_run$(run_num).png"), fig, px_per_unit=2)
...
#save(joinpath(output_path, "eNd_transects.png"), s)
#save(joinpath(archive_path, "eNd_transects_$(lastcommit)_run$(run_num).png"), s)
use_GLMakie || save(joinpath(archive_path, "eNd_transects_$(lastcommit)_run$(run_num).pdf"), fig)
#use_GLMakie || save(joinpath(archive_path, "eNd_transects_$(lastcommit)_run$(run_num).png"), px_per_unit=2, fig)
